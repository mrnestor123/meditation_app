...
void main() {
  test('Meditation and lesson testing', () {
    MissionModel m = new MissionModel(
        type: "meditation", xp: 100, requirement: "time", done: false);
    //el requerimiento será meditar 20 min
    m.requirements = [20];
    MissionModel u = new MissionModel(
        type: "lesson", xp: 100, requirement: "list", done: false);
    ...
    MeditationModel m1 = new MeditationModel(
        duration: Duration(minutes: 10), day: new DateTime(2020));
    Meditation m5 = new MeditationModel(
        duration: Duration(minutes: 10), day: new DateTime(2020));
    MeditationModel m2 = new MeditationModel(
        duration: Duration(minutes: 5),
        day: new DateTime(2020).add(Duration(days: 1)));
    MeditationModel m3 = new MeditationModel(
        duration: Duration(minutes: 5),
        day: new DateTime(2020).add(Duration(days: 2)));
    MeditationModel m4 = new MeditationModel(
        duration: Duration(minutes: 5),
        day: new DateTime(2020).add(Duration(days: 3)));
    ...
    MeditationModel m6 = new MeditationModel(
        duration: Duration(minutes: 5),
        day: new DateTime(2020).add(Duration(days: 5)));
