...
class User {
  String nombrepila, mail, userName;
  UserState state;
  Feed feed;
  int assignedStage, id;
  Meditation currentMeditation;

  ObservableList<Meditation> totalMeditations = new ObservableList();
  ObservableList<Lesson> lessonslearned = new ObservableList();
  ObservableList<Lesson> remainingLessons = new ObservableList();
...
//For adding user to the DB. Its lists are populated in the service.
  ...
  ObservableList<Lesson> getRemainingLessons() => this.remainingLessons;

  ObservableList<Meditation> getTotalMeditations() => this.totalMeditations;
  ...
  void addLesson(Lesson l) => this.remainingLessons.add(l);
