...
mixin _$RequestState on _RequestState, Store {
  ...
  @override
  Future<dynamic> getRequests({String coduser}) {
  ...
  @override
  Future<dynamic> setRequest({String cod, Request r}) {
    return _$setRequestAsyncAction.run(() => super.setRequest(cod: cod, r: r));
  }
