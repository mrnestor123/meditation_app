        ...
        children: <Widget>[
          SingleChildScrollView(
            ...
            Container(
              ...
              child:Center(child: Text(lesson.title, style: Configuration.title)),
            ),
            Container(
              padding: EdgeInsets.all(Configuration.safeBlockHorizontal*10),
              child: Text(lesson.text,style: Configuration.longtext),
            )
          ])),
          new Positioned(
