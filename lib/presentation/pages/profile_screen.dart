...
import 'package:meditation_app/presentation/pages/commonWidget/calendar.dart';
...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Widget teacherProfile(User user, int i){
    ...
    Widget addedContent(){
      return user.addedcontent.length > 0 || user.addedsections.length > 0 ? 
        Column(
          children: [
            Row(children: [
              ...
              SizedBox(width: Configuration.verticalspacing),
              Text('Added content', style: Configuration.text('small',Colors.black)),
            ]),
            SizedBox(height: Configuration.verticalspacing),

            user.addedsections.length > 0 ?
            ListView.builder(
              shrinkWrap: true,
              physics: NeverScrollableScrollPhysics(),
              itemCount: user.addedsections.length,
              
              itemBuilder: (context, index) {
                Section e  = user.addedsections[index];
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Flexible(child: Text('Meditation record', style: Configuration.text('subtitle', Colors.black))),
  ...
  void didChangeDependencies(){
    ...
    _profilestate.init(
      ...
      /*if(_profilestate.selected.isTeacher()){
        if(_profilestate.selected.addedcontent.length > 0 || _profilestate.selected.addedsections.length > 0){
  ...
  void changeImage({onSelectImage}){
              ...
              GridView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  ...
                  return GestureDetector(
                    onTap: (){
                      _userstate.user.setImage(svgCode);
                      _userstate.updateUser();
                      
                      if(onSelectImage != null){ onSelectImage(); }
              ...
              child: _userstate.user.totalMeditations.length  > 0 ?  ListView.separated(
                ...
                itemBuilder: ((context, index) {
                  ...
                  return ListTile(
                    ...
                    trailing: m.report != null ?
                      Icon(Icons.notes, color: Colors.black, size: Configuration.smicon) : 
                      Container(width: Configuration.smicon),
